...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        # TODO
        self.regularization = nodes.L2NormPenaltyNode(l2_reg = l2_reg,
                w = self.w, node_name = "regularization")
        self.loss = nodes.SquaredL2DistanceNode(a=self.prediction, b=self.y,
                                               node_name="square loss")
        self.objective = nodes.SumNode(self.loss, self.regularization, node_name
                = "objective")
